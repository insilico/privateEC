...
Consensus nested cross validation (cnCV) is a new method ...
...
### Simulate Quantitative Outcome Data (parameter in effect: label = "phenos", type = "mainEffect", importance.algorithm = "RReliefFequalK")
```{r, message=FALSE}
n.samples <- 100
n.variables <- 100
label <- "phenos"
