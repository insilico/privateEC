---
title: "Private Evaporative Cooling and Nested CV Vignette with Interaction Simulation"
...
### Simulate Balanced Case-Control Data with Numeric Predictors with interaction Effects
```{r, message=FALSE}
library(privateEC)
...
bias <- 0.4          # moderate effect size, smaller value is larger effect
